...
const NAV: Record<UserRole, NavItem[]> = {
  firma: [
    ...
    { labelPL: "Pracownicy", labelUA: "Працівники",      href: "/dashboard/firma/pracownicy", icon: <IconUsers />, badge: undefined },
  ...
  pracownik: [
    ...
    { labelPL: "Wnioski",      labelUA: "Заяви",            href: "/dashboard/pracownik/wnioski",       icon: <IconRequest /> },
