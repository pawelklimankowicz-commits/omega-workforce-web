    ...
    <header className="fixed inset-x-0 top-0 z-50">
        ...
        <div className="container-x flex h-9 items-center justify-between text-xs">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-0.5 rounded-lg border border-white/[0.07] bg-white/[0.03] p-0.5"
              role="group" aria-label="Wybór języka">
              ...
              {(["PL", "UA"] as const).map((l) => (
                <button key={l} onClick={() => setLang(l)}
                  ...
                  aria-label={`Język ${l}`} aria-pressed={lang === l}>
                  {l}
                </button>
              ))}
            </div>
      ...
      <div className={`border-b transition-all duration-200 ${
        ...
        <nav className="container-x flex h-16 items-center justify-between gap-4"
          ...
          <a href="#top" aria-label={`${company.name} — strona główna`}
            className="z-50 shrink-0 rounded-lg outline-none">
            <Logo variant="horizontal" height={LOGO_H} />
          </a>
          ...
          <button onClick={() => setOpen(!open)}
            ...
            aria-label={open ? (lang === "UA" ? "Закрити" : "Zamknij menu") : (lang === "UA" ? "Відкрити меню" : "Otwórz menu")}
      ...
      <div id="mobile-menu" role="dialog" aria-modal="true" aria-label="Menu"
        ...
        <div className="h-16 flex items-center px-5" aria-hidden>
          <Logo variant="horizontal" height={LOGO_H} />
        </div>
        <div className="flex-1 overflow-y-auto px-5 pt-4 pb-10">
          ...
          <div className="mb-6 flex items-center gap-2">
            ...
            <span className="text-xs text-fg-faint mr-1">{lang === "UA" ? "Мова:" : "Język:"}</span>
            {(["PL", "UA"] as const).map((l) => (
              <button key={l} onClick={() => setLang(l)}
          ...
          <div className="mt-6 rounded-2xl border border-white/[0.06] bg-white/[0.02] p-4 space-y-2">
            ...
            <p className="text-xs text-fg-faint">
              ...
              {lang === "UA" ? "Легальне агентство зайнятості" : "Legalne zatrudnienie"}
            </p>
          </div>
        </div>
      </div>
